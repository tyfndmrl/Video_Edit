...
| SignalR/Redis: YAZILMADI, iskele duruyor — KARAR AÇIK | tespit 2026-08-25 | İlerleme yoklamayla çalışıyor; tasarım 03 vaadi uygulanmadı | (henüz karar yok) | Kullanıcı: getir ya da sök |
