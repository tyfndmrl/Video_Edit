...
- Çalıştırma (Bash aracı; birincil kabuk PowerShell'de `VAR=x cmd` öneki PARSE HATASI verir —
  ...
  ```
- Doğrulama: 2026-09-04 (panel-denetim-7 sonu) yeşil sayıları: backend 1626 · editör 1549 · şema 235 (bunlar BÜYÜR; skip 0 sabittir).
...
- Çalıştırma: `pnpm exec playwright test` (apps/editor içinde). 2026-09-04 (panel-denetim-7 sonu): 197 test / 51 spec / 12,5 dk.
