...
- Çalıştırma (Bash aracı; birincil kabuk PowerShell'de `VAR=x cmd` öneki PARSE HATASI verir —
  ...
  ```
- Doğrulama: 2026-09-01 (özellik turu dilim 2 sonu) yeşil sayıları: backend 1626 · editör 1379 · şema 235 (bunlar BÜYÜR; skip 0 sabittir).
...
- Çalıştırma: `pnpm exec playwright test` (apps/editor içinde). 2026-09-01 (özellik turu dilim 2 sonu): 167 test / 43 spec / 10,5 dk.
