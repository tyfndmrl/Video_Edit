...
- Çalıştırma (Bash aracı; birincil kabuk PowerShell'de `VAR=x cmd` öneki PARSE HATASI verir —
  ...
  ```
- Doğrulama: 2026-09-05 (panel-denetim-8 sonu) yeşil sayıları: backend 1626 · editör 1551 · şema 235 (bunlar BÜYÜR; skip 0 sabittir).
...
- Çalıştırma: `pnpm exec playwright test` (apps/editor içinde). 2026-09-05 (panel-denetim-8 sonu): 197 test / 51 spec / 12,2 dk.
