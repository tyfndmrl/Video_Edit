        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProxyKey = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    FilmstripKey = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    WaveformKey = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ThumbnailKey = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    Probe = table.Column<JsonDocument>(type: "jsonb", nullable: true),
                    DurationMicros = table.Column<long>(type: "bigint", nullable: true),
                    Width = table.Column<int>(type: "integer", nullable: true),
                    Height = table.Column<int>(type: "integer", nullable: true),
                    FpsNum = table.Column<int>(type: "integer", nullable: true),
                    FpsDen = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimelineSnapshot = table.Column<JsonDocument>(type: "jsonb", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FrameRateNum = table.Column<int>(type: "integer", nullable: false),
                    FrameRateDen = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectAssets", x => new { x.ProjectId, x.AssetId });
                    table.ForeignKey(
